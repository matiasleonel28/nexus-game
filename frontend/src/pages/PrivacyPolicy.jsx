  ...
  return (
    <div className="min-h-screen bg-[var(--ink)] text-[var(--text)] p-8 flex flex-col items-center justify-center">
      <div className="max-w-3xl w-full bg-[var(--surface)] p-8 rounded-lg border border-[var(--line)] shadow-xl">
        <h1 className="text-3xl font-bold text-[var(--text)] mb-6 tracking-tight">Política de Privacidad</h1>
        
        <div className="space-y-6 text-sm text-[var(--muted)] leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-[var(--text)] mb-2">1. Datos que recolectamos</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text)] mb-2">2. Uso de la información</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text)] mb-2">3. Tus derechos y eliminación de datos</h2>
        ...
        <div className="mt-8 pt-6 border-t border-[var(--line)]">
          <NavLink to="/" className="text-[var(--accent)] hover:text-[var(--text)] transition-colors text-sm font-semibold uppercase tracking-wider">
